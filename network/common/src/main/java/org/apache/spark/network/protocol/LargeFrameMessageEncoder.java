...
public final class LargeFrameMessageEncoder extends MessageToMessageEncoder<LargeFrameMessage> {

  private final Logger logger = LoggerFactory.getLogger(LargeFrameMessageEncoder.class);
