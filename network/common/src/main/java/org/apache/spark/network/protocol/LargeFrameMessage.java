...
public interface LargeFrameMessage extends Encodable {
  /** Used to identify this request type. */
  Type type();

  /** Preceding every serialized Message is its type, which allows us to deserialize it. */
  public static enum Type implements Encodable {
    TestMessage(0), LargeChunkFetchSuccess(1);
    ...
    public static Type decode(LargeByteBuf buf) {
      byte id = buf.get();
      switch (id) {
        case 0: return TestMessage;
        case 1: return LargeChunkFetchSuccess;
