 ...
 *
 * NB: This class is used to make requests to the server, while {@link org.apache.spark.network.client.TransportResponseHandler} is
 * responsible for handling responses from the server.
 *
 * Concurrency: thread safe and can be called from multiple threads.
 */
public class LargeTransportClient implements Closeable {
  private final Logger logger = LoggerFactory.getLogger(LargeTransportClient.class);

  private final Channel channel;
  private final TransportResponseHandler handler;

  public LargeTransportClient(Channel channel, TransportResponseHandler handler) {
